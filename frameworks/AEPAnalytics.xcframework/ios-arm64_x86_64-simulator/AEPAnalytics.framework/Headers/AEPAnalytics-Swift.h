...
SWIFT_CLASS("_TtC12AEPAnalytics13AnalyticsBase")
@interface AnalyticsBase : NSObject <AEPExtension>
...
SWIFT_CLASS_NAMED("Analytics") SWIFT_AVAILABILITY(tvos_app_extension,unavailable) SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS_NAMED("AnalyticsAppExtension")
...
@interface AnalyticsBase (SWIFT_EXTENSION(AEPAnalytics))
